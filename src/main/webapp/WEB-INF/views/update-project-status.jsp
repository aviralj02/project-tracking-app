...
<body>
	<div class="home">
		...
		<div class="login-form">
			<form:form action="processStatusUpdate?uname=${userDetails.getUsername()}" method="post" modelAttribute="projectData">
				<form:input type="text" path="pid" class="form-control" readonly="true" />
				<br>
				<form:input type="text" path="pname" placeholder="Project Name" class="form-control" readonly="true" />
				<br>
				<br>
